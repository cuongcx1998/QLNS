...
<center>
    <div class="backk" style="float: left; margin-left: 120px;">
        <button><a href="faculty_per_campus.php">Back</a></button>
    </div>
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        $afilter = $con->prepare("SELECT atotal1.atotal2 + atotal3.atotal4 as atotal FROM (
                            ...
                            FROM   tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Alijis' AND per_designation in ('Permanent' , 'Part Time') 
                            ) as atotal1,
                            (
                            SELECT COUNT(*) as atotal4
                            FROM   tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Alijis'AND per_designation in ('Permanent' , 'Part Time')
                            ) as atotal3 ");
                            $afilter->execute();
                        ...
                        $tfilter = $con->prepare("SELECT ttotal1.ttotal2 + ttotal3.ttotal4 as ttotal FROM (
                            ...
                            FROM   tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Talisay' AND per_designation in ('Permanent' , 'Part Time') 
                            ) as ttotal1,
                            (
                            SELECT COUNT(*) as ttotal4
                            FROM   tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Talisay' AND per_designation in ('Permanent' , 'Part Time')
                            ) as ttotal3 ");
                        $tfilter->execute();
                        ...
                        $bfilter = $con->prepare("SELECT btotal1.btotal2 + btotal3.btotal4 as btotal FROM (
                            ...
                            FROM tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Binalbagan' AND per_designation in ('Permanent' , 'Part Time') 
                            ) as btotal1,
                            (
                            SELECT COUNT(*) as btotal4
                            FROM tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Binalbagan' AND per_designation in ('Permanent' , 'Part Time')
                            ) as btotal3 ");
                            ...
                            FROM tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Fortune Towne' AND per_designation in ('Permanent' , 'Part Time') 
                            ) as fttotal1,
                            (
                            SELECT COUNT(*) as fttotal4
                            FROM tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Fortune Towne' AND per_designation in ('Permanent' , 'Part Time')
                            ) as fttotal3 ");
                        ...
                        <?php
                        include('connect.php');
                         $display = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Talisay' AND per_designation in ('Permanent' , 'Part Time')");
                            $display->execute();
                        ...
                        <?php
                         ...
                         $display1 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Alijis' AND per_designation in ('Permanent' , 'Part Time')");
                            $display1->execute();
                        ...
                        <?php
                         ...
                         $display2 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Fortune Towne' AND per_designation in ('Permanent' , 'Part Time')");
                            $display2->execute();
                        ...
                        <?php
                         ...
                         $display3 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Binalbagan' AND per_designation in ('Permanent' , 'Part Time')");
                            $display3->execute();
                        ...
                        <?php
                         ...
                         $display4 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel WHERE per_designation in ('Permanent' , 'Part Time')");
                            $display4->execute();
