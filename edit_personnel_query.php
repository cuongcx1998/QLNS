...
if(isset($_POST['update'])) {
	...
	$add_personnel = $con->prepare("UPDATE tbl_personnel SET per_firstname = ?, per_middlename = ?, per_lastname = ?, per_gender = ?, per_status = ?, per_address = ?, pos_id = ?, per_employee_status = ?, per_date_of_birth = ?, per_place_of_birth = ?, per_date_of_original_appointment = ? , per_contact_no = ?, rank_id = ? , per_campus = ?, dept_id = ?, bs_name = ?, bs_year = ?, bs_school = ?, ms_name = ?, ms_with_unit = ?, ms_year = ?, ms_school = ?, dr_name = ?, dr_with_unit = ?, dr_year = ?, dr_school = ?, other_degree = ?, other_year = ?, other_school = ?, date_modified = NOW(), gass_id = ? WHERE per_id = ?");
	$add_personnel->execute(array($per_firstname, $per_middlename, $per_lastname, $per_gender, $per_status, $per_address, $pos_id, $per_employee_status, $per_date_of_birth, $per_place_of_birth, $per_date_of_original_appointment, $per_contact, $rank, $per_campus, $dept_id, $bs_name, $bs_year, $bs_school, $ms_name, $ms_with_unit, $ms_year, $ms_school, $dr_name, $dr_with_unit, $dr_year, $dr_school, $other_degree, $other_year, $other_school, $gass_id, $per_id));
