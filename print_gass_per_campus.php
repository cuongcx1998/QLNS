...
<center>
    <div class="backk" style="float: left; margin-left: 120px;">
        <button><a href="gass_per_campus.php">Back</a></button>
    </div>
        ...
        <br />
            ...
            <table id = "example" class = "stripe order-table" cellspacing = "0" style="margin: 10px;">
               <thead>
                                    <tr>
                                        <th > Campus</th>
                                        <th >Number of GASS Personnel</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
                                    $afilter = $con->prepare("SELECT atotal1.atotal2 + atotal3.atotal4 as atotal FROM (
                                        ...
                                        FROM   tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Alijis' AND per_designation = 'GASS'
                                        ) as atotal1,
                                        (
                                        SELECT COUNT(*) as atotal4
                                        FROM   tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Alijis'AND per_designation = 'GASS'
                                        ) as atotal3 ");
                                        $afilter->execute();
                                    ...
                                    $tfilter = $con->prepare("SELECT ttotal1.ttotal2 + ttotal3.ttotal4 as ttotal FROM (
                                        ...
                                        FROM   tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Talisay' AND per_designation = 'GASS' 
                                        ) as ttotal1,
                                        (
                                        SELECT COUNT(*) as ttotal4
                                        FROM   tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Talisay' AND per_designation = 'GASS' 
                                        ) as ttotal3 ");
                                    $tfilter->execute();
                                    ...
                                    $bfilter = $con->prepare("SELECT btotal1.btotal2 + btotal3.btotal4 as btotal FROM (
                                        ...
                                        FROM tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Binalbagan' AND per_designation = 'GASS'
                                        ) as btotal1,
                                        (
                                        SELECT COUNT(*) as btotal4
                                        FROM tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Binalbagan' AND per_designation = 'GASS'
                                        ) as btotal3 ");
                                        ...
                                        FROM tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Fortune Towne' AND per_designation = 'GASS'
                                        ) as fttotal1,
                                        (
                                        SELECT COUNT(*) as fttotal4
                                        FROM tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Fortune Towne' AND per_designation = 'GASS'
                                        ) as fttotal3 ");
                                ...
                                <thead>
                                    <tr>
                                        <td>CAMPUS</td>
                                        <td>Number of GASS Personnel</td>
                                    </tr>
                                </thead>
                                <tbody>
                                <tr>
                                <?php
                                include('connect.php');
                                 $display = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Talisay' AND per_designation = 'GASS' ");
                                    $display->execute();
                                ...
                                <?php
                                 ...
                                 $display1 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Alijis' AND per_designation = 'GASS' ");
                                    $display1->execute();
                                ...
                                <?php
                                 ...
                                 $display2 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Fortune Towne' AND per_designation = 'GASS' ");
                                    $display2->execute();
                                ...
                                <?php
                                 ...
                                 $display3 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Binalbagan' AND per_designation = 'GASS' ");
                                    $display3->execute();
                                ...
                                <?php
                                 ...
                                 $display4 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel WHERE per_designation = 'GASS' ");
                                    $display4->execute();
