...
<center>
  <div class="backk" style="float: left; margin-left: 120px;">
    <button><a href="binalbagan_campus.php">Back</a></button>
  </div>
...
//    css_html = css_html.replace(/ /g, '%20');
    ...
    a.download = 'Binalbagan Personnel_' + postfix + '.xls';
